public class find {
        ...
        public static void lsSingle(String args){
            try {
                ...
                // if name is a directory open it and read the contents
                    ...
                    while (true) {
                        ...
                        //System.out.println("test entryName: " + entryName);
         ...
         */
        private static void print( String name , String parent)
        {
